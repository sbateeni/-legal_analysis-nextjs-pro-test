...
7. إذا طلب المستخدم بيانات محددة (مثل أسماء الأطراف أو تواريخ أو مبالغ) وكان النص في "التحليل السابق" يحتوي عليها، فاستخرجها بدقة وقدّمها في "answer". إن لم تكن متوفرة، اطلبها باقتcisار دون إطالة عامة.
8. تجنّب التكرار والإنشاء المطوّل غير الضروري. اعرض إجابة مركّزة أولاً ثم اقتراحات وخطوات لاحقاً.
9. إخلاء مسؤولية: هذه المعلومات للتثقيف والدعم وليست بديلاً عن استشارة محامٍ مرخّص في فلسطين عند الحاجة.
`;
}
